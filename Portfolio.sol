...
contract Portfolio{
  ...
  //     string compamyName;
  // }
  //as dynamic array is more in cost so fixed size array used 
  Project[3] public projects;
  Education[3] public educationDetails;
  //Experience[3] public experienceDetails;

  string public imageLink="QmQFwFWkgEgNjPQF8cAPw5gmF4mVNgT2cYBQaDd7Z3ZZtA";
  ...
  string public resumeLink="QmbDbczBoamjiAn7gcyMTQdE2K9KeYqR7czcM2VKerBghc";
  uint projectCount;
  uint educationCount;
  ...
  //so that only manager can use these functions
  ...
  //Project
  //calldata used rather than memory for gas optimizations
  //mostly in fucntions we used external keyword and here we have created modifier onlyManager so for only mnager to work we put the modifier name after external keyword
