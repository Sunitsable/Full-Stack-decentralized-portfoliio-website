        ...
        <section className="project-section">
            ...
            <div className="card-wrapper">
                {projects !== "" && projects.map((project, index) => {
                    const githubLink = `https://github.com/Sunitsable/${project.githubLink}`;
                    return (
            ...
            <Modal size='md' isOpen={modal} toggle={() => setModal(!modal)} modalClassName="custom-modal">
            ...
            <p className='donate' onClick={() => setModal(true)}>
                Liked the dummyValue's ? Consider donating Eth's <FaDonate className='icon' />
            </p>
        </section>
    )
}
